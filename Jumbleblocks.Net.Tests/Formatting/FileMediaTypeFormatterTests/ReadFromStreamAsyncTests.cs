...
{
    [TestFixture]
    public class ReadFromStreamAsyncTests : FileMediaTypeFormatterTestBase
    {
        ...
        public void Call_ReadFromStreamAsync()
        {
            try
            {
                var task = ItemUnderTest.ReadFromStreamAsync(_type, _stream.Object, _httpContent.Object, _formatterLogger.Object);
                task.Wait();
            }
